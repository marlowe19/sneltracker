  ...
  function handleShareClick() {
    if (!initialNote.share_token) {
      ...
      fetch(
        ...
        .then((data) => {
          if (data.share_token) {
            const shareUrl = `${window.location.origin}/shared/notes/${data.share_token}`;
        ...
        .catch((error) => {
          ...
          alert("Kon share token niet genereren");
        });
    } else {
      const shareUrl = `${window.location.origin}/shared/notes/${initialNote.share_token}`;
