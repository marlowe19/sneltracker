 ...
 *
 * Usage:
 *   node scripts/backup-firebase.js                    # Uses .env.local (default)
 *   ENV_FILE=.env.development node scripts/backup-firebase.js
 *   npm run backup:firebase:dev                        # Uses .env.development
