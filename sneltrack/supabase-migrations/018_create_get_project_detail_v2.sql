-- Migration 018: Create get_project_detail_v2 function with capacity_per_week in members
-- Adds capacity_per_week field to the members JSONB array for project forecasting

CREATE OR REPLACE FUNCTION get_project_detail_v2(
  p_user_name TEXT,
  p_project_id UUID,
...
-- Add comment
COMMENT ON FUNCTION get_project_detail_v2 IS 
'Get detailed project information including statistics and members (v2).
Includes capacity_per_week in the members JSONB array for project forecasting.';
